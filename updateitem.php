...
if (isset($_POST['iId'])) {
    ...
    $query = "SELECT iName, iDescription, iPrice, iSize FROM Item WHERE iId = '$iId'";
    $result = queryMysql($query);
...
<form action="updateitem.php" method="POST">
    <fieldset>
        ...
        Description: </br>
        <textarea maxlength="200"id="iDescription" name="iDescription" required value="<?php echo $iDescription; ?>"></textarea><br>
        Price: </br>
